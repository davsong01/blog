...
@section('header')
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url({{ asset($post->image) }});"
        data-overlay="9">
        <div class="container text-center">
            ...
            <div class="row h-100">
                ...
                <p><img class="avatar avatar-sm" src="{{ Gravatar::src(asset($post->user->email)) }}"></p>
